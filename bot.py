...
please rewrite my full bot.py into a Python 3.9 + PTB v13 version that:Runs immediately on HosteonsSends Telegram messages every 60sCan include basic trading/prediction logicUses no heavy libraries (so no pip crashes) import requests
import pandas as pd
